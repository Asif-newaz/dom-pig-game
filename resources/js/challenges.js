...
document.querySelector('.btn-roll').addEventListener('click', function () {
    ...
    if (gamePlaying) {
        ...
        document.getElementById('dice-1').src = 'resources/img/dice-' + dice1 + '.png';
        document.getElementById('dice-2').src = 'resources/img/dice-' + dice2 + '.png';
        ...
        /*
        // This code will work up to Challenge 2
...
function init() {
    ...
    // This code will work when the user clicks the HOLD button
